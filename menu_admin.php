...
<div class="container">
    ...
    <div class="container-fluid">
        <a href="menu_admin_create.php" class="btn btn-secondary" role="button">Add New Item</a>
        <form method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="d-flex" role="search">

            <button class="btn btn-success" type="submit">Search</button>
            <input class="form-control" type="search" placeholder="Search by keyword" name="keyword" aria-label="Search">
