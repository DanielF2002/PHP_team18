    ...
    <div class="container row d-lg-flex align-items-center">
        <form class="col-12 col-lg-6" method="post" action=<?php echo $branchesAction; ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" <?php branchesSetValue("name"); ?>>
            </div>
            <div class="form-group">
                <label for="email" class="fs-5">Email</label>
                <input type="email" class="form-control" id="email" <?php branchesSetValue("email"); ?>>
            </div>
            <div class="form-group">
                <label for="tel" class="fs-5">Telephone</label>
                <input type="tel" class="form-control" id="tel" <?php branchesSetValue("tel"); ?>>
            </div>
            <div class="form-group">
                <label for="url" class="fs-5">Url</label>
                <input type="url" class="form-control" id="url" <?php branchesSetValue("url"); ?>>
            </div>
            <div class="form-group">
                <label for="add" class="fs-5">Address</label>
                <input type="text" class="form-control" id="add" <?php branchesSetValue("add"); ?>>
            </div>
            <div class="d-grid">
